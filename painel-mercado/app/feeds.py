...
FEEDS = [
    ...
    {"url": "https://www.investing.com/rss/news_1.rss", "source": "Investing.com Forex", "default_cat": "cambio"},
...
CATEGORY_KEYWORDS = {
    ...
    "cambio": ["dólar", "dolar", "câmbio", "cambio", "usd/brl", "ptax", "euro",
               "moeda americana", "moeda norte-americana", "eur/usd", "gbp/usd",
               "usd/jpy", "eur/jpy", "eur/chf", "libra esterlina", " libra ",
               "iene", "franco suíço", "franco suico", "forex", " yen ",
               " pound", "sterling", "yuan", " won ", "peso mexicano"],
